    ...
    return (
        ...
        >
            ...
            <p className="text-gray-700 -mt-6 dark:text-white/80">
                ...
                </a>{" "}<br/> or via call +8801968450105
            ...
            >
                <input
                    className="h-14 px-4 rounded-lg borderBlack dark:bg-gray-800 dark:focus:bg-gray-700 transition-all dark:outline-none"
                    name="senderEmail"
                    type="email"
                    required
                    maxLength={500}
                ...
                />
                <textarea
                    className="h-52 my-3 rounded-lg borderBlack p-4 dark:bg-gray-800 dark:focus:bg-gray-700 transition-all dark:outline-none"
                    name="message"
